...
Once the `conda-forge` channel has been enabled, `flang, flang_linux-64, flang_win-64, libflang, libfortran-main, libfortran-main_linux-64, libfortran-main_win-64` can be installed with `conda`:

```
conda install flang flang_linux-64 flang_win-64 libflang libfortran-main libfortran-main_linux-64 libfortran-main_win-64
```

or with `mamba`:

```
mamba install flang flang_linux-64 flang_win-64 libflang libfortran-main libfortran-main_linux-64 libfortran-main_win-64
```
